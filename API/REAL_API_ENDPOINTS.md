...
```json
{
  ...
  "phone": "+375299605390",
  "group": "420603",
  "photoUrl": "https://storage.googleapis.com/students-bsuir.appspot.com/public_ids/c7ee6f20-d5e3-4a75-81e2-456e4e9b77e8id=26198.jpg",
  "isGroupHead": false,
...
struct LoginResponse: Codable {
    ...
    let phone: String
    let group: String         // Номер группы, например "420603"
    let photoUrl: String?
...
```json
{
  ...
  "graduating": false,
  "summary": null,
  "photo": "https://storage.googleapis.com/students-bsuir.appspot.com/public_ids/c7ee6f20-d5e3-4a75-81e2-456e4e9b77e8id=26198.jpg",
...
request.httpBody = try? JSONEncoder().encode(LoginRequest(username: "42850012", password: "password"))
