...
extension UserSettings {
    nonisolated static let `default` = UserSettings(
...
extension User {
    func updatingSettings(_ settings: UserSettings) -> User {
        User(
            ...
            belarusianFirstName: belarusianFirstName,
            belarusianLastName: belarusianLastName,
            belarusianMiddleName: belarusianMiddleName,
            birthDay: birthDay,
            email: email,
            phone: phone,
            photo: photo,
...
extension User {
    ...
    static let mock = User(
        ...
        lastName: "Парамонов",
        middleName: "Иванович",
        belarusianFirstName: "Антон",
        belarusianLastName: "Парамонаў",
        belarusianMiddleName: "Іванавіч",
        birthDay: "2000-01-15",
