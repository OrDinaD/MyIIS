...
struct ScheduleSettingsView: View {
    ...
    var body: some View {
        NavigationStack {
            ...
            .confirmationDialog(
                NSLocalizedString("schedule_settings_reset_all", comment: ""),
                isPresented: $isResetConfirmationPresented,
                titleVisibility: .visible
            ) {
                Button(NSLocalizedString("schedule_settings_reset_all", comment: ""), role: .destructive) {
                    resetAllSettings()
                }
    ...
    private func colorRow(category: LessonTypeCategory, color: Binding<Color>) -> some View {
        HStack {
            ...
            ColorPicker(category.localizedTitle, selection: color, supportsOpacity: false)
                .labelsHidden()
