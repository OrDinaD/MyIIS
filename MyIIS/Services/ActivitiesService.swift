...
@MainActor
final class ActivitiesService: ActivitiesServiceProtocol {
    ...
    convenience init(responseDelay: UInt64 = 250_000_000) {
        self.init(
            activities: Activity.previewActivities,
            categories: ActivityCategory.previewCategories,
